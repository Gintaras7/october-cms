...
<ul>
    <li><a href="<?= Backend::url('gintaras/consumption/consumption') ?>">Consumption</a></li>
...
<?php if (!$this->fatalError) : ?>
    ...
    <div class="form-buttons">
        <div class="loading-indicator-container">
            ...
            <span class="btn-text">
                <?= e(trans('backend::lang.form.or')) ?> <a href="<?= Backend::url('gintaras/consumption/consumption') ?>"><?= e(trans('backend::lang.form.cancel')) ?></a>
            </span>
        </div>
    </div>
...
<?php else : ?>
    ...
    <p><a href="<?= Backend::url('gintaras/consumption/consumption') ?>" class="btn btn-default"><?= e(trans('backend::lang.form.return_to_list')) ?></a></p>
<?php endif ?>